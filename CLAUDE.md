...
| `StrataTimeline` | MACB timeline + per-artifact timeline projections (30 sources) + gap/session analysis |
...
- **Per-OS tab hiding.** Artifact tabs that can't apply to the evidence's OS are
  ...
  Network & Devices + QuickLook & Trash, `nil` = cross-platform incl.
