...
struct KillChainView: View {
    ...
    var body: some View {
        ...
        return VStack(alignment: .leading, spacing: 0) {
            ...
            // The AI summary lives on the Overview tab only — embedding it in this
            // plain VStack forced a bounded-height internal ScrollView whose
            // height-measurement dance glitched the layout here.
