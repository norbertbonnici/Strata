...
struct SidebarItemOSTests {
    ...
    @Test func macArtifactsAreTaggedMac() {
        for item in [SidebarItem.launchItems, .quarantine, .macPersistence, .fsEvents] {
    ...
    @Test func everySidebarItemPartitionsCleanly() {
        ...
        // launchItems, quarantine, macPersistence, fsEvents, unifiedLog, tcc,
        // knowledgeC, macRecentItems, macSecurity.
        #expect(mac.count == 9)
    }
}
